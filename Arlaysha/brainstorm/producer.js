...
// ear-ish 
// HOW to make the map ect that had a symbol on the map SHOWING true at first so see ALL then you could run search() function so that javescript makes producers that DO NOT match NOT display on the map for results 
